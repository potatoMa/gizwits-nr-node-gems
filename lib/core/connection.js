...
function openInternal(settings) {
    return __awaiter(this, void 0, void 0, function () {
        var protocol, socketOpts, ca;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    protocol = settings.useTLS ? 'amqps' : 'amqp';
                    if (settings.useTLS) {
                        ca = tls_1.cert(settings.useCA ? settings.ca : undefined);
                        socketOpts = {
                            ca: [ca],
                        };
                    }
...
var Connection = /** @class */ (function () {
    function Connection(settings) {
        ...
        this.__conn = new resource_1.ResourceHandler(function () { return openInternal(_this.__settings); }, {
            name: 'Connection',
        });
    }
    ...
    Connection.prototype.close = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.__conn.close()];
            });
        });
    };
    Connection.prototype.createChannel = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.__conn.resource()];
                    case 1:
                        conn = _a.sent();
                        return [2 /*return*/, conn.createChannel()];
                }
            });
        });
    };
    ...
    Connection.prototype.once = function (event, handler) {
